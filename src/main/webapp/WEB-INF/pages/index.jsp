...
<head>
    ...
    <!--icheck-->
    <link href="/resource/js/iCheck/skins/minimal/minimal.css" rel="stylesheet">
    <link href="/resource/js/iCheck/skins/square/square.css" rel="stylesheet">
    <link href="/resource/js/iCheck/skins/square/red.css" rel="stylesheet">
    <link href="/resource/js/iCheck/skins/square/blue.css" rel="stylesheet">

    <!--dashboard calendar-->
    <link href="/resource/css/clndr.css" rel="stylesheet">

    <!--Morris Chart CSS -->
    <link rel="stylesheet" href="/resource/js/morris-chart/morris.css">
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="index.html"><img src="/resource/images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="index.html"><img src="/resource/images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    <img alt="" src="/resource/images/photos/user-avatar.png" class="media-object">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/auth_login?client_id=145a8799-9bd3-48e2-b7cb-2824c39656b9&scope=all&auth_type=auth_code&redirect_url=http://www.baidu.com&state=123"><i
                            class="fa fa-sign-in"></i> <span>Login Page</span></a></li>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu dropdown-menu-head pull-right">
                            ...
                            <ul class="dropdown-list normal-list">
                                <li class="new">
                                    <a href="">
                                        <span class="thumb"><img src="/resource/images/photos/user1.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="/resource/images/photos/user2.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="/resource/images/photos/user3.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="/resource/images/photos/user4.png" alt=""/></span>
                                        <span class="desc">
                                ...
                                <li>
                                    <a href="">
                                        <span class="thumb"><img src="/resource/images/photos/user5.png" alt=""/></span>
                                        <span class="desc">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="/resource/images/photos/user-avatar.png" alt=""/>
                            John Doe
                            ...
                            <ul class="goal-progress">
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resource/images/photos/user1.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resource/images/photos/user2.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resource/images/photos/user3.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resource/images/photos/user4.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                ...
                                <li>
                                    <div class="prog-avatar">
                                        <img src="/resource/images/photos/user5.png" alt=""/>
                                    </div>
                                    <div class="details">
                                        <div class="title">
                                            <a href="#">Hoffman Doe</a> - Support
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="/resource/images/photos/user2.png" alt=""/>
                                </a>
                                <div class="media-body">
...
<script src="/resource/js/jquery-ui-1.9.2.custom.min.js"></script>
...
<!--easy pie chart-->
<script src="/resource/js/easypiechart/jquery.easypiechart.js"></script>
<script src="/resource/js/easypiechart/easypiechart-init.js"></script>
...
<!--icheck -->
<script src="/resource/js/iCheck/jquery.icheck.js"></script>
<script src="/resource/js/icheck-init.js"></script>

<!-- jQuery Flot Chart-->
<script src="/resource/js/flot-chart/jquery.flot.js"></script>
<script src="/resource/js/flot-chart/jquery.flot.tooltip.js"></script>
<script src="/resource/js/flot-chart/jquery.flot.resize.js"></script>


<!--Morris Chart-->
<script src="/resource/js/morris-chart/morris.js"></script>
<script src="/resource/js/morris-chart/raphael-min.js"></script>

<!--Calendar-->
<script src="/resource/js/calendar/clndr.js"></script>
<script src="/resource/js/calendar/evnt.calendar.init.js"></script>
<script src="/resource/js/calendar/moment-2.2.1.js"></script>
...
<!--Dashboard Charts-->
<script src="/resource/js/dashboard-chart-init.js"></script>
